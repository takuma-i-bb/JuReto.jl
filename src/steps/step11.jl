...
export Variable, backward, Square, square, Exp, exp, Add
...
function (f::MyFunction)(inputs::Vector{<:Variable})
...
# import Base; +
# function +(xs::Vector{Variable})
#     Add()(xs)
# end

function forward(f::Add, xs)
    x0, x1 = xs[1], xs[2]
    y = x0 + x1
    return [y]
end
